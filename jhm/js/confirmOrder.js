;$(function(){
	$('.confirm1-btn').click(function(){
		var _addresser=$('.confirm1-ipt1').val();
		$('.addressP1').html(_addresser);
		var _address=$('#s1').val()+$('#s2').val()+$('#s3').val()+$('.confirm1-ipt2').val();
		$('.addressP2').html(_address);
		var _phone=$('.confirm1-ipt5').val();
		$('.addressP3').html(_phone);
		$('.confirm1-address').fadeIn();
	});
	$('.confirm1-addressA2').click(function(){
		$('.confirm1-address').fadeOut();
	});
});
function Dsy()
{
